...
4. `ubi addons` currently exposes public associated products from the catalog graph; it does not prove add-on ownership for the authenticated account without a working live Demux ownership path.[4][12]
