...
- 2026-03-23: Implemented `demux-list`, `demux-info`, `download-urls`, and live Demux-backed `manifest/files/download-plan --live` flows with passing unit/smoke coverage.
